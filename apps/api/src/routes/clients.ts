...
router.post('/', asyncHandler((req: Request, res: Response) => {
  ...
  logAudit('client', result.lastInsertRowid, 'created', { legal_name, site_address });
...
router.put('/:id', asyncHandler((req: Request, res: Response) => {
  ...
  logAudit('client', Number(req.params.id), 'updated', { legal_name: legal_name ?? client.legal_name });
...
router.delete('/:id', asyncHandler((req: Request, res: Response) => {
  ...
  logAudit('client', Number(req.params.id), 'deleted', { legal_name: client.legal_name });
