...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 1
ON CONFLICT (section_id, ordinal) DO NOTHING;
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 2
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 3
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 4
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 5
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 6
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 7
ON CONFLICT (section_id, ordinal) DO NOTHING;
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-class-6-1a-6-1b-6-1c-8-2a-8' AND t.revision = 1 AND sec.ordinal = 8
ON CONFLICT (section_id, ordinal) DO NOTHING;
...
FROM checksheet_template WHERE code = 'wks17-general' AND revision = 1
ON CONFLICT (template_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 1
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 2
ON CONFLICT (section_id, ordinal) DO NOTHING;
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 3
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 4
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 5
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 6
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 7
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
...
FROM checksheet_section sec
JOIN checksheet_template t ON t.id = sec.template_id
WHERE t.code = 'wks17-general' AND t.revision = 1 AND sec.ordinal = 8
ON CONFLICT (section_id, ordinal) DO NOTHING;
INSERT INTO checksheet_item (section_id, ordinal, number, regulation_refs, regulation_refs_by_class, regulation_raw, guidance_url, action, records, evidence_required)
