...
| 17–60 | Comments column, red = non-compliant | `finding.comment`, `finding.status` | editable Comments cell, red text | ✅ inline editing, commits on focus loss |
...
| 64 | "Section 1/1" | `template.sheet.footer` | footer | ✅ ⚠️ source says 1/1 for sheet 1 of 2 — reproduced verbatim |
